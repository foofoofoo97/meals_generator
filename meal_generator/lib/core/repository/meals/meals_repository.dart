...
class MealsRepository extends IRepository<UiMealsCategory,Meals> {

  late MealsApiProvider _mealsApi;
  ...
  @override
  Future<Either<Exception, List<Meals>>> getAllChoicesByCategory(String categoryName) async {
    try {
      var result = await _mealsApi.getAllChoicesByCategory(categoryName);
