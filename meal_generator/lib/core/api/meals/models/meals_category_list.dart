...
class MealsCategoryList {
  ...
  factory MealsCategoryList.fromJson(Map<String, dynamic> json) =>
      _$MealsCategoryListFromJson(json);
...
class MealsCategory {
  ...
  MealsCategory(this.id, this.name, this.thumbnailUrl, this.description);
